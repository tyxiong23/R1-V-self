...
def main(args):
    ...
    # OUTPUT_DIR=os.path.join(args.model_path, 'eval_geoqa')
    ...
    for input_example, model_output in zip(data,all_outputs):
        ...
        output_answer = original_output.split("<answer>")[-1].split("</answer>")[0]
        model_answer = parse(output_answer) 
        ...
        try:
            ...
            print("no answer parsed",e,model_answer, model_output)
            result = {
                'question': input_example,
                'ground_truth': ground_truth,
                'model_output': original_output,
