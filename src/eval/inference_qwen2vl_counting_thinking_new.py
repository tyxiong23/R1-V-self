    ...
    for i in batch:
        message = [
            ...
            },
            {
                ...
                "content": [
                    {
                        "type": "text", "text": i[args.question_key]
                    },
                    {
                        "type": "image", 
                        "image": f"file://{os.path.join(args.image_folder, i[args.image_key])}"
                    }
                ]
            }
        ]
        ...
        #         {
        #             "type": "text",
        #             "text": QUESTION_TEMPLATE.format(Question=i[args.question_key])
        #         }
        #     ]
        # }]
        # print(message)
