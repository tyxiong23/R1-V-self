...
RUN_NAME="grpo-softV1_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_lr${LR}_formatAlpha${FORMAT_REWARD_ALPHA}_warmup-gemini-v0-mix-balanced-epoch1-lr${WARMUP_LR}-SpecialToken-SoftCE"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-softReward/warmup-specialToken-SoftCE-mix-balanced-lr${WARMUP_LR}+grpo-softV1/${DATA_NAME}/${RUN_NAME}
