...
RUN_NAME="grpo_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_lr${LR}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_warmup-gemini-v0-mix-balanced-epoch1-lr${WARMUP_LR}-SpecialToken30-SoftCE"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-softReward/warmup-specialToken30-SoftCE-mix-balanced-lr${WARMUP_LR}+grpo/${DATA_NAME}/${RUN_NAME}
