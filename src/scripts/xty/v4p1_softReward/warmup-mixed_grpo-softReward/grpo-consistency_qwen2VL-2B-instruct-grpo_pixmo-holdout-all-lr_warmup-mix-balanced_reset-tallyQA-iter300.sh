...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/v4-grpo-softReward/warmup-mix-balanced-lr1e-6+grpo-consistency/tallyQA_filterV1_geminiV0-holdout-all/grpo-consistency-softV1_Qwen2-VL-2B-Instruct_tallyQA_filterV1_geminiV0-holdout-all_maxlen512_numgen8_epoch1_lr1e-6_formatAlpha1.0_consistency_warmup-gemini-v0-mix-balanced-epoch1/checkpoint-300"
# MODEL_PATH=""
...
RUN_NAME="grpo-consistency-softV1-reset-tallyQA-iter300_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_lr${LR}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_warmup-gemini-v0-mix-balanced-epoch1_grpo-soft-tallyQA-iter300"
