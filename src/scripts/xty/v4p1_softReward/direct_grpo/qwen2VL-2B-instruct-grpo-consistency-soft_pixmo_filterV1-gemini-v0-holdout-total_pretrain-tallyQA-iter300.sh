...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/v4-grpo-softReward/direct-grpo_consistency/tallyQA_filterV1_geminiV0-holdout-all/grpo-consistency-softV1_Qwen2-VL-2B-Instruct_tallyQA_filterV1_geminiV0-holdout-all_maxlen512_numgen8_epoch1_formatAlpha1.0_consistency/checkpoint-300"
MODEL_SHORT='Qwen2-VL-2B-Instruct'
EPOCH=1
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="grpo-consistency-softV1_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_pretrain-tallyQA-grpoSoft-iter300"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-softReward/direct-grpo_consistency/${DATA_NAME}/${RUN_NAME}
