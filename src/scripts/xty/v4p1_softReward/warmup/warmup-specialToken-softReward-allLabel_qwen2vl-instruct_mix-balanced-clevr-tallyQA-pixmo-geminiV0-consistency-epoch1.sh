...
RUN_NAME="warmup-specialToken-softReward-${REWARD_FUNC_VERSION}-lambda${COUNT_TOKEN_LAMBDA}-allLabel_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-softReward/warmup_specialToken_softReward_allLabel/${DATA_NAME}/${RUN_NAME}
...
torchrun --nproc_per_node="8" \
    ...
    --master_port="12345" \
    src/r1-v/src/open_r1/sft_new_specialToken_softReward.py \
