...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/training_v1/Clevr_CoGenT_TrainA_70K_Complex/Qwen2-VL-2B-Instruct_Clevr_CoGenT_TrainA_70K_Complex_maxlen1024_numgen8_epoch2/checkpoint-300"
...
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_lr${lr}_pretrain-CLEVR-complex-300iter"
