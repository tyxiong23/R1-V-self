...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/training_v1_consistency/Clevr_CoGenT_TrainA_70K_Complex/Qwen2-VL-2B-Instruct_Clevr_CoGenT_TrainA_70K_Complex_maxlen1024_numgen8_epoch2_consistency/checkpoint-300"
MODEL_SHORT=$(basename "$MODEL_PATH")
EPOCH=2
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency__pretrain-clevr-complex-iter300"
