...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/training_v2_consistency/tallyQA_filterV1_len7_amt_vg_vqa_qwenVL2-2B/Qwen2-VL-2B-Instruct_tallyQA_filterV1_len7_amt_vg_vqa_qwenVL2-2B_maxlen512_numgen8_epoch2_formatAlpha1.0_consistency/checkpoint-300"
MODEL_SHORT=$(basename "$MODEL_PATH")
EPOCH=2
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency__pretrain-tallyQA-consistency-iter300"
OUTPUT_DIR=${WORKDIR}/outputs/training_v2_consistency/${DATA_NAME}/${RUN_NAME}
