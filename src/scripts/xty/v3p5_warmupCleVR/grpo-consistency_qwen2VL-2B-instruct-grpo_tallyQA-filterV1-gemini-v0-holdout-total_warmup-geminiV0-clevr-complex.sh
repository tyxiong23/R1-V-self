...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/warmup/warmup_gemini-v0-CleVR-complex-consistent/warmup_v0_Qwen2-VL-2B-Instruct_warmup_gemini-v0-CleVR-complex-consistent_epoch3_lr1e-5/checkpoint-1333"
MODEL_SHORT="Qwen2-VL-2B-Instruct"
EPOCH=1
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="grpo-consistency_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_warmup-gemini-v0-CleVR-complex-epoch1"
OUTPUT_DIR=${WORKDIR}/outputs/v3p5_warmupCLeVR/warmup+grpo-consistency/${DATA_NAME}/${RUN_NAME}
