...
DATA_NAME="warmup_gemini-v0-pixmo-points-consistent"
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/pixmo-points/distilled-reasoning/consistency/gemini-2.0-flash-thinking-exp-distill-v0_pixmo-points-counting_filterV1_train_consistent.jsonl"
