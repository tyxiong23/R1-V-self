...
MODEL_PATH="/home/tixiong/storage/checkpoints/Qwen2.5-VL-3B-Instruct-SpecialToken-NUM100"
MODEL_SHORT='Qwen2.5-VL-3B-Instruct'
EPOCH=1
lr=1e-5

DATA_NAME="refcocog-30k-2-specialToken"
DATA_PATH="/lustre/fsw/portfolios/${PORTOFOLIOS}/users/tixiong/datasets/data/grounding/Refcoco_train_grpo/specialToken/refcocog_train_processed_20k_1.jsonl"
RUN_NAME="warmup-v3-specialToken_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
...
torchrun --nproc_per_node="8" \
    ...
    --master_port="12345" \
    src/r1-v/src/open_r1/sft_new_v3_specialToken_softReward_qwen2p5vl.py \
