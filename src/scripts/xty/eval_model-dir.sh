...
bash /home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/src/scripts/xty/infer_pixmo-counting/eval_qwen2VL_pixmo-count-test_group.sh $model_dir