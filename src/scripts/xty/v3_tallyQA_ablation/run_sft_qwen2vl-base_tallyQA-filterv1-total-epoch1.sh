...
DATA_NAME="tallyQA-train-filterV1_geminiV0-noDistill-SFT"
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/tallyQA/train_filterV1_len7_amt_vg_vqa.jsonl"
RUN_NAME="v3-tallyQA-gemini-v0_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
OUTPUT_DIR=${WORKDIR}/outputs/v3-tallyQA-geminiV0/${DATA_NAME}/${RUN_NAME}
