...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/warmup/warmup_gemini_250310-v0_tallyQA/warmup_v0_Qwen2-VL-2B-Instruct_warmup_gemini_250310-v0_tallyQA_epoch3_lr1e-5/checkpoint-116"
MODEL_SHORT="Qwen2-VL-2B-Instruct"
EPOCH=1
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_warmup-gemini-v0-epoch1"
OUTPUT_DIR=${WORKDIR}/outputs/v3-tallyQA-geminiV0/warmup+grpo/${DATA_NAME}/${RUN_NAME}
