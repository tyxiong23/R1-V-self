...
DATA_NAME="tallyQA_filterV1_geminiV0-holdout-split-grpo"
...
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/tallyQA/splits/250310-gemini-v0/parquet/tallyQA-train-filterV1_no-gemini-distilled_split-grpo"
# IMAGE_FOLDER="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/tallyQA/images"

MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/v3-tallyQA-geminiV0/sft-warmup-grpo/warmup_gemini_250310-v0_tallyQA/warmup_v0_Qwen2-VL-2B-Instruct_warmup_gemini_250310-v0_tallyQA_epoch1_lr1e-5/checkpoint-115"
MODEL_SHORT="Qwen2-VL-2B-Instruct"
EPOCH=1
MAX_COMPLETION_LEN=512
NUM_GEN=8
FORMAT_REWARD_ALPHA=${FORMAT_REWARD_ALPHA:-1.0}
RUN_NAME="grpo_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_warmup-gemini-v0-epoch1"
OUTPUT_DIR=${WORKDIR}/outputs/v3-tallyQA-geminiV0/sft-warmup-grpo/${DATA_NAME}/${RUN_NAME}
