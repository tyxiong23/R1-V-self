...
DATA_NAME="tallyQA-train-filterV1_geminiV0-noDistill-split-sft"
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/tallyQA/splits/250310-gemini-v0/tallyQA-train-filterV1_no-gemini-distilled_split-sft.jsonl"
RUN_NAME="v3-tallyQA-gemini-v0_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
