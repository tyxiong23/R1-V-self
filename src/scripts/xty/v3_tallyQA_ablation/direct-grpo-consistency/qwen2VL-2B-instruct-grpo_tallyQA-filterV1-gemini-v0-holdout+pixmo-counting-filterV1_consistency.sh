...
DATA_NAME="tallyQA-filterV1-geminiV0-holdout+pixmo-points-counting-filterV1"
...
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/pixmo-points/parquet/pixmo-point-counting-filterV1-train__tallyQA-train-filterV1-holdout-geminiV0"
...
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency"
OUTPUT_DIR=${WORKDIR}/outputs/v3-tallyQA-geminiV0+pixmo/direct-grpo_consistency/${DATA_NAME}/${RUN_NAME}
