...
RUN_NAME="grpo-reset_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_resetIter300"
OUTPUT_DIR=${WORKDIR}/outputs/v3-tallyQA-geminiV0/direct-grpo_consistency/${DATA_NAME}/${RUN_NAME}
