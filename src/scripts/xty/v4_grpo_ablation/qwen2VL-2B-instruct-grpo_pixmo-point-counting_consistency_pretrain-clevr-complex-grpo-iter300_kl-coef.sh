...
KL_COEF=$1
RUN_NAME="grpo-ablation-kl-coef-${KL_COEF}_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_pretrain-clevr-complex-grpo-iter300"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-ablations/kl-coef/${DATA_NAME}/${RUN_NAME}
