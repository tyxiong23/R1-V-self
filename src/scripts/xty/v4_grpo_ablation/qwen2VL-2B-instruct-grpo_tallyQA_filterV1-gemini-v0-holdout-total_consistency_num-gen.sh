...
KL_COEF=0.04
RUN_NAME="grpo-ablation-kl-coef-${KL_COEF}-numgen${NUM_GEN}_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-ablations/numgen/${DATA_NAME}/${RUN_NAME}
