...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/v3p7-grpo-tallyQA+pixmo/direct-grpo_consistency/pixmo-point-counting_filterV1_train/grpo-consistency_Qwen2-VL-2B-Instruct_pixmo-point-counting_filterV1_train_maxlen512_numgen8_epoch1_formatAlpha1.0_consistency_pretrain-clevr-complex-grpo-iter300/checkpoint-300"
...
# KL_COEF=$1
RUN_NAME="grpo-reset-iter300_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_pretrain-clevr-complex-grpo-iter300"
OUTPUT_DIR=${WORKDIR}/outputs/v4-grpo-ablations/grpo-reset/${DATA_NAME}/${RUN_NAME}
