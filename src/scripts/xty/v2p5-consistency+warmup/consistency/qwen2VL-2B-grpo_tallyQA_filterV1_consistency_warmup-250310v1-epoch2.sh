...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/warmup/warmup_gemini_250310-v1_tallyQA/warmup_v1_Qwen2-VL-2B_warmup_gemini_250310-v1_tallyQA_epoch3_lr1e-5/checkpoint-82"
...
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency__warmup-v1-250310-tallyQA-epoch2"
OUTPUT_DIR=${WORKDIR}/outputs/training_v2p5_consistency-wamrup/${DATA_NAME}/${RUN_NAME}
