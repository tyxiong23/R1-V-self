...
NUM_GEN=4
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_consistency"
OUTPUT_DIR=${WORKDIR}/outputs/training_v1_consistency/${DATA_NAME}/${RUN_NAME}
