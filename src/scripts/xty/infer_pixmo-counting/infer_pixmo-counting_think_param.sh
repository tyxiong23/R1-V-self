...
# MODEL_PATH="Qwen/Qwen2-VL-2B-Instruct"
# OUTPUT_BASE="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/inference/pixmo-counting-test/${MODEL_SHORT}/think_then_answer"

QUESTION_FILE="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/pixmo-counts/pixmo-count_test.jsonl"
