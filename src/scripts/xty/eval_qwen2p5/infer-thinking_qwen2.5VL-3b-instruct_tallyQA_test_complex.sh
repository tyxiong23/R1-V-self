...
OUTPUT_BASE="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/eval/${MODEL_SHORT}/eval-thinking_tallyQA_test_complex_subset_1.5k"
# MODEL_SHORT=$(basename "$MODEL_PATH")
...
for chunk in $(seq 0 $((NUM_CHUNKS-1))); do
    ...
    CUDA_VISIBLE_DEVICES=${chunk} \
        python3 /home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/src/eval/inference_qwen2vl_counting_thinking.py \
