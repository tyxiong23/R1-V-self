...
OUTPUT_BASE="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/eval/${MODEL_SHORT}/eval-direct-enumerate_tallyQA_test_complex_subset_1.5k"
# MODEL_SHORT=$(basename "$MODEL_PATH")
