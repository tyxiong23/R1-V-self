...
DATA_NAME="warmup_gemini_250310-v1-total_tallyQA"
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/tallyQA/distilled-reasoning/processed/250310_v1_gemini-2.0-flash-thinking-exp-total-NUM2575.jsonl"
RUN_NAME="warmup_v1_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
