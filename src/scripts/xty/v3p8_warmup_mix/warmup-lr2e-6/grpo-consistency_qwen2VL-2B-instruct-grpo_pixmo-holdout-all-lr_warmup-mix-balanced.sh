...
MODEL_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/outputs/warmup/warmup_gemini-v0-mix-balanced-consistent-13k/warmup_v0_Qwen2-VL-2B-Instruct_warmup_gemini-v0-mix-balanced-consistent-13k_epoch1_lr2e-6/checkpoint-859"
...
RUN_NAME="grpo-consistency_${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_lr${LR}_formatAlpha${FORMAT_REWARD_ALPHA}_consistency_warmup-gemini-v0-mix-balanced-epoch1-lr2e-6"
OUTPUT_DIR=${WORKDIR}/outputs/v3p8_warmup-mix-balanced/warmup-lr2e-6+grpo-consistency/${DATA_NAME}/${RUN_NAME}
