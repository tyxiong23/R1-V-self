...
DATA_PATH="/home/tixiong/storage/xty-workspace/multimodal-reasoning/datasets/pixmo-points/warmup-mix-balanced_clevr-complex+tallyQA+pixmo.jsonl"
RUN_NAME="warmup-v3_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
