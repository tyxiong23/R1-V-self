...
IMAGE_FOLDER="/lustre/fsw/portfolios/${PORTOFOLIOS}/users/tixiong/xty-workspace/multimodal-reasoning/datasets"
...
DATA_NAME="warmup_gemini-v0-mix-balanced-consistent-13k"
DATA_PATH="/lustre/fsw/portfolios/${PORTOFOLIOS}/users/tixiong/xty-workspace/multimodal-reasoning/datasets/pixmo-points/warmup-mix-balanced_clevr-complex+tallyQA+pixmo.jsonl"
RUN_NAME="warmup-v3-sysPrompt-openR1_v0_${MODEL_SHORT}_${DATA_NAME}_epoch${EPOCH}_lr${lr}"
OUTPUT_DIR=${WORKDIR}/outputs/warmup/${DATA_NAME}/${RUN_NAME}


ACCELERATE_LOG_LEVEL=info \
accelerate launch --config_file src/r1-v/configs/zero3.yaml \
    src/r1-v/src/open_r1/sft_new_v3_systemPrompt.py \
...
bash /home/tixiong/storage/xty-workspace/multimodal-reasoning/R1-V/src/scripts/xty/eval_model-dir.sh $model_dir
