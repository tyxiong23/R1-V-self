...
RUN_NAME="${MODEL_SHORT}_${DATA_NAME}_maxlen${MAX_COMPLETION_LEN}_numgen${NUM_GEN}_epoch${EPOCH}_formatAlpha${FORMAT_REWARD_ALPHA}_new"
OUTPUT_DIR=${WORKDIR}/outputs/training_v2_base_new/${DATA_NAME}/${RUN_NAME}
